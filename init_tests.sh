...
cmd+=("$tester_pathname BONUS 1 800 200 200")

cmd+=("$tester_pathname BONUS 5 800 200 200")

cmd+=("$tester_pathname BONUS 5 800 200 200 7")

cmd+=("$tester_pathname BONUS 4 410 200 200")

cmd+=("$tester_pathname BONUS 4 310 200 100")

cmd+=("$tester_pathname BONUS 2 200 100 100")

cmd+=("$tester_pathname BONUS 2 400 100 100")

cmd+=("$tester_pathname BONUS 2 400 100 400")

cmd+=("$tester_pathname BONUS 2 400 300 200")
